...
<a href = "accueil.html"> <p align="center"><img src ="logo1.png"> </p></a>
 ...
 <body>
  ...
  <!-- CORPS DE LA PAGE  -->
  <h2>Bienvenue chez Del Arte</h2></br>
  <form method = "post" action = "del_arte.php"><br>
  ...
  if (isset($_POST['new_commande'])){
    ...
    foreach($array_plats as $plat){
      ...
      echo "<form method = 'post' action = 'del_arte.php'>
  ...
  <?php
       $req_info_restos = $cnx->query("SELECT adresse,ville,horaire_ouverture,horaire_fermeture,prix_livraison  FROM restaurant WHERE nom_rest = 'Del Arte'");
