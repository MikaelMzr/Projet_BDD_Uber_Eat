...
<a href = "Accueil.html"> <p align="center"><img src ="logo1.png"> </p></a>
 ...
 <body>
  ...
  if (isset($_SESSION['login'])){
    ...
    $req_insert_note = $cnx->prepare("INSERT INTO Commanter VALUES (:id_cli,:id_rest,:note,:commentaire,:id_plat");
    ...
    $req_update_etat_commandes =$cnx->query("UPDATE commande SET etat ='livrer' WHERE etat ='En livraison'");
